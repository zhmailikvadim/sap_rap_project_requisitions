CLASS zcl_calc_virtuals_epic DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_CALC_VIRTUALS_EPIC IMPLEMENTATION.
  ...
  METHOD if_sadl_exit_calc_element_read~calculate.
    ...
    DATA lt_original_data TYPE STANDARD TABLE OF znbs_c_epic WITH DEFAULT KEY.
    ...
    LOOP AT lt_original_data ASSIGNING FIELD-SYMBOL(<fs_original_data>).
      zcl_static_methods=>calcmptstatuschar( EXPORTING iv_datecreated = <fs_original_data>-Created
                                                       ...
                                                       iv_status = <fs_original_data>-EpicStatus_Name
       ...
       if <fs_original_data>-Developer = zcl_static_methods=>uuidinitial.
        <fs_original_data>-developer_criticality = 1.
       endif.
    ENDLOOP.
